...
import { Folder, ClockIcon, Plus } from 'lucide-react';
      ...
      <div className="flex flex-col pt-10 border-b border-light-200/20 dark:border-dark-200/20 pb-6 px-2">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-3">
          <div className="flex items-center justify-center">
            <Folder size={45} className="mb-2.5" />
            <div className="flex flex-col">
              ...
              <div className="px-2 text-sm text-black/60 dark:text-white/60 text-center lg:text-left">
                Organize your chats into spaces.
              </div>
            </div>
          </div>

          <div className="flex items-center justify-center lg:justify-end gap-2">
            <CreateSpaceDialog spaces={spaces} setSpaces={setSpaces} />
            <span className="text-xs text-black/60 dark:text-white/60 inline-flex items-center gap-1 rounded-full border border-black/20 dark:border-white/20 px-2 py-0.5">
              <Folder size={14} />
              {loading
                ? 'Loading…'
